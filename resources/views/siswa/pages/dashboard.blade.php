    ...
    <section id="dashboard-siswa" class="bg-off-white text-slate-navy pt-40 sm:pt-44 pb-16 sm:pb-24">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5 sm:gap-6 max-w-5xl mx-auto">
                <a href="{{ route('siswa.materi.index') }}" class="bg-off-white border border-border-gray hover:shadow-xl rounded-2xl p-6 sm:p-8 transition-all duration-300 hover:scale-105 hover:-translate-y-2 group">
