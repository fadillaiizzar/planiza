    ...
    <body class="font-inter bg-gradient-to-br from-off-white to-slate-100 min-h-screen overflow-x-hidden">
                ...
                <div class="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl border border-border-gray/30 p-8 sm:p-10 lg:p-12">
                    ...
                    <form action="{{ route('siswa.kenali-jurusan.form-kuliah.store') }}" method="POST" id="formKuliah" class="space-y-6">
                        ...
                        <div>
                            ...
                            <input type="number" id="nilai_utbk" name="nilai_utbk" required min="0" max="1000"
                        ...
                        <div>
                            ...
                            <select id="jurusan_kuliah_ids" name="jurusan_kuliah_ids[]" multiple required
                                ...
                                @foreach ($jurusanKuliah as $jurusan)
                                    <option value="{{ $jurusan->id }}">{{ $jurusan->nama_jurusan_kuliah }}</option>
                                @endforeach
                            </select>
        ...
        <script>
            ...
            // Inisialisasi Select2 untuk hobi
            $('#hobi_ids').select2({
            ...
            // Update counter setiap kali berubah
            ...
            document.getElementById('formKuliah').addEventListener('submit', function (e) {
                if ($('#jurusan_kuliah_ids').val().length === 0) {
                    e.preventDefault();
                    alert('⚠️ Pilih minimal 1 jurusan!');
                    return;
                }
                if ($('#hobi_ids').val().length === 0) {
                    e.preventDefault();
