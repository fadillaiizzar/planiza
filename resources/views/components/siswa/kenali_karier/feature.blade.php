...
<div class="group bg-white/50 backdrop-blur-sm border border-border-gray hover:border-slate-navy rounded-2xl p-6 hover:shadow-2xl hover:shadow-slate-navy/10 transition-all duration-300 hover:-translate-y-2"
